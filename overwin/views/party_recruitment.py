...
class RecruitmentListView(generic.ListView):
    model = Recruitment
    template_name = 'overwin/party_recruitment/index.html'
...
class PartyRecruitmentCreateView(generic.CreateView):
    template_name = "overwin/party_recruitment/create.html"
    model = Recruitment
...
class PartyRecruitmentUpdateView(generic.UpdateView):
    template_name = 'overwin/party_recruitment/update.html'
    model = Recruitment
    form_class = RecruitmentForm
...
class PartyRecruitmentDeleteView(generic.DeleteView):
    model = Recruitment
    success_url = reverse_lazy('overwin:party_recruitment_list')
    template_name = 'overwin/party_recruitment/delete.html'
