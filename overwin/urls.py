...
from .views import mypage,account_register_and_login,search_game_player,account_info
...
urlpatterns = [
    ...
    path('search_player/',search_game_player.GamePlayerSearchView.as_view(), name='search_game_player'),
    path('favorite_player/',search_game_player.FavoriteGamePlayerView.as_view(), name='favorite_game_player'),
